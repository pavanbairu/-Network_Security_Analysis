...
class TrainingPipelineConfig():
    def __init__(self, timestamp=datetime.now()):
        ...
        self.artficat_dir = os.path.join(self.artifact_name, timestamp)
...
class DataIngestionConfig():
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.data_ingestion_dir: str = os.path.join(training_pipeline_config.artficat_dir,training_pipeline.DATA_INGESTION_DIR_NAME)
...
class DataValidationConfig():
    def __init__(self, training_pipeline_conffig: TrainingPipelineConfig):
        self.data_validation_dir: str = os.path.join(training_pipeline_conffig.artficat_dir,training_pipeline.DATA_VALIDATION_DIR_NAME)
